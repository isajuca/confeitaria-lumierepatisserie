              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="p-3 bg-[#E8CFCF] rounded-full">
                      <Mail className="h-5 w-5 text-[#D7A3A3]" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="p-3 bg-[#E8CFCF] rounded-full">
                      <Phone className="h-5 w-5 text-[#D7A3A3]" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="p-3 bg-[#E8CFCF] rounded-full">
                      <MapPin className="h-5 w-5 text-[#D7A3A3]" />
                    </div>
                    <div>
                ...
                <div>
                  ...
                  <div className="flex space-x-4">
                    ...
                    <a
                      ...
                      className="p-3 bg-[#E8CFCF] rounded-full hover:bg-[#D7A3A3] transition-colors text-white inline-block"
                    >
            ...
            <Card className="h-full">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  {/* Botão de Envio */}
                  <Button type="submit" className="w-full font-semibold bg-[#D7A3A3] hover:bg-[#C98E8E] text-white transition-colors">
                    Enviar Mensagem
                  </Button>
